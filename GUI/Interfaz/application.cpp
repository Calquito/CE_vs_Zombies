...
Application::Application()
{
    ...
    m_image = load_surface("/home/allan/Desktop/CE_vs_Zombies-master/CE_vs_Zombies-master/GUI/tablero.bmp");
    ...
    planta1= load_surface("/home/allan/Desktop/CE_vs_Zombies-master/CE_vs_Zombies-master/GUI/Lanzagisantes.bmp");
...
void Application::generar_zombie(int x, int y){
    ...
    nuevo_zombie = load_surface("/home/allan/Desktop/CE_vs_Zombies-master/CE_vs_Zombies-master/GUI/zombie.bmp");
    ...
    while(keep_window_open)
    {
        ...
        if(planta_presionada) {
            if (SDL_GetMouseState(&x, &y) & SDL_BUTTON(SDL_BUTTON_LEFT) && x<535) {
                ...
                nueva_planta = load_surface("/home/allan/Desktop/CE_vs_Zombies-master/CE_vs_Zombies-master/GUI/Lanzagisantes.bmp");
                ...
                nuevo_disparo = load_surface("/home/allan/Desktop/CE_vs_Zombies-master/CE_vs_Zombies-master/GUI/pregunta.bmp");
